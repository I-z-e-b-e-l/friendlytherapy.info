...
//This is the ame as in Update-6
...
update_provider: (request, response) => {
  ...
  Providers.findByIdAndUpdate(id, {$set: {  
    ...
    commentsAdmin: request.body.admin_comments_update
      ...
      if (error) {
        console.log("some kind of error is happening")
          return error;
      } else {
          response.redirect('/admin');
      }
  ...
  // This is the same update_provider as in update-7
//   update_provider: (request, response) => {
...
//     }}, {new: true}, (error) => {
//         if (error) {
//             console.log("should return an error here");
//             return error;
