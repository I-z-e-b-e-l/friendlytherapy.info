...
module.exports = {
    ...
    add_a_provider_client_input_post: (request, response ) => {
        ...
        let newProvider = new Providers ({
            ...
            adhdRating: request.body.adhd_rating,
            austismRating: request.body.autism_rating,
            disabilityRating: request.body.disability_rating,
            traumaRating: request.body.trauma_rating,
            substanceUseRating: request.body.substance_use_rating,
